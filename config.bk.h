...
static const char *sel_tag_char[2]   = {"{", "}"};
static const char *occ_tag_char[2]   = {"*", " "};
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray1, col_white,  col_gray4  },
};

/* tagging */
static const char *tags[] = { "www", "•", "txt", "•", "spt", "•", "dsc"};
...
//static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_white, "-sb", col_white, "-sf", col_gray1, NULL };
